...
export const TasksApp = () => {
    ...
    useEffect(() => {
        localStorage.setItem('tasks-state', JSON.stringify(state.todos));
    }, [state]);
    const addTodo = () => {
        if (inputValue.trim() === '') return;

        //en react no hacer todos.push(newTodo), sino que se hace una nueva referencia al array con el nuevo elemento, para que react detecte el cambio y vuelva a renderizar
